...
const dict: Dict = {
  ...
  "admin.resendConn": { he: "Resend (מיילים לפרויקט)", en: "Resend (project emails)", ar: "Resend (بريد المشروع)" },
  "admin.resendApiKey": { he: "Resend API Key", en: "Resend API Key", ar: "Resend API Key" },
  "admin.resendApiKeyHint": { he: "השאר ריק בעריכה כדי לא לשנות.", en: "Leave blank when editing to keep the existing key.", ar: "اتركه فارغًا عند التعديل للاحتفاظ بالمفتاح." },
  "admin.resendFromEmail": { he: "כתובת שולח", en: "From address", ar: "عنوان المرسل" },
  "admin.resendFromHint": { he: "למשל: Al-Nour Bakery <orders@domain.com>", en: "e.g. Al-Nour Bakery <orders@domain.com>", ar: "مثل: Al-Nour Bakery <orders@domain.com>" },
  "admin.resendAdminEmail": { he: "מייל אדמין (test mode)", en: "Admin email (test mode)", ar: "بريد المسؤول (وضع الاختبار)" },
  "admin.emailTestMode": { he: "מצב בדיקה — שלח רק למייל האדמין", en: "Test mode — send only to admin email", ar: "وضع الاختبار — الإرسال لبريد المسؤول فقط" },
